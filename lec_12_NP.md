...
Hence the prove the theorem we need to show that  $\varphi$ is satisfiable if and only if $G$ contains an independent set of $n+m$ vertices. We now show both directions of this equivalence:
>
