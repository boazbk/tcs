...
They should be able to follow through the logic of _proofs_ about computation, including the central concept of a _reduction_ as well understand  "self-referential" proofs (such as diagonalization-based proofs that involve programs given their own code as input).
